...
public class Lab026TestIntergrationrunusingtestng {
    //create booking
    //create a token
    //create a booking
    //perform put
...
@BeforeTest
    ...
    @Test(dependsOnMethods = "update_booking_id")
    ...
    @Test(dependsOnMethods = "verify_update_booking_idgetRequest")
    ...
    @Test(dependsOnMethods = "delete_bookingid")
