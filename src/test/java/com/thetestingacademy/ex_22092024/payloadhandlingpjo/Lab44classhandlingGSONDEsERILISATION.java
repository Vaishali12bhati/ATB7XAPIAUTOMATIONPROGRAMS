...
public class Lab44classhandlingGSONDEsERILISATION {
...
//    ValidatableResponse validatableResponse;
    ...
    public void gsonserilizationpostpositive() {
        ...
        bookingc.setFirstname("vaishali");
        bookingc.setLastname("bhati");
        bookingc.setTotalprice(5647);
        bookingc.setDepositpaid(true);
        ...
        bookingc.setBookingdates(bookingdates);
        bookingc.setAdditionalneeds("breakfast");
        System.out.println(bookingc);//object we are printing
        //CONVERTING OBJECT TO STRING //serilisation

        Gson gson = new Gson();
        String jsonStringpayload = gson.toJson(bookingc);
        ...
        //now we parse the request //deserlization
        DesBookingResponse bookingResponse = gson.fromJson(ResponseString,DesBookingResponse.class);
       System.out.println(bookingResponse.getBookingid());
        System.out.println(bookingResponse.getBookingc().getFirstname());
    }}
